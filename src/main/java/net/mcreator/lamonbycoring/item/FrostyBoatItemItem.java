...
public class FrostyBoatItemItem extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:frosty_boat_item")
	public static final Item block = null;
	public FrostyBoatItemItem(LamonByCoringModElements instance) {
		super(instance, 116);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("frosty_boat_item");
		}
