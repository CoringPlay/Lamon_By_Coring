...
package net.mcreator.lamonbycoring.entity;
...
public class CrabEntity extends LamonByCoringModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16737895, -10092442, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("crab_spawn_egg"));
	}
