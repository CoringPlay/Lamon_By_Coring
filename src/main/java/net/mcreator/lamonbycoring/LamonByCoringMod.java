 ...
 *
 *    Keep the LamonByCoringModElements object in this class and all calls to this object
...
@Mod("lamon_by_coring")
public class LamonByCoringMod {
	public static final Logger LOGGER = LogManager.getLogger(LamonByCoringMod.class);
	...
	public LamonByCoringMod() {
		...
		MinecraftForge.EVENT_BUS.register(new LamonByCoringModFMLBusEvents(this));
	}
