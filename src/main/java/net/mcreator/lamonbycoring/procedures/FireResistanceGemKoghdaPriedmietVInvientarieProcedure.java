...
public class FireResistanceGemKoghdaPriedmietVInvientarieProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				LamonByCoringMod.LOGGER.warn("Failed to load dependency entity for procedure FireResistanceGemKoghdaPriedmietVInvientarie!");
			return;
		}
