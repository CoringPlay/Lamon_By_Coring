...
public class WhiteSandBlock extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:white_sand")
	public static final Block block = null;
	public WhiteSandBlock(LamonByCoringModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:white_sand_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lamon_by_coring:white_sand"), configuredFeature);
		}
	}
	@SubscribeEvent
