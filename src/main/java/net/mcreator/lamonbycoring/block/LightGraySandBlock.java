...
public class LightGraySandBlock extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:light_gray_sand")
	public static final Block block = null;
	public LightGraySandBlock(LamonByCoringModElements instance) {
		super(instance, 15);
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(0.25f, 10f).setLightLevel(s -> 0).harvestLevel(1)
					.harvestTool(ToolType.SHOVEL).setRequiresTool());
			setRegistryName("light_gray_sand");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:light_gray_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("light_gray_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lamon_by_coring:light_gray_sand"), configuredFeature);
		}
	}
	@SubscribeEvent
