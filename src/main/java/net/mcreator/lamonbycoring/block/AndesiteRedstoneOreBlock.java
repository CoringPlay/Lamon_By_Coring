...
public class AndesiteRedstoneOreBlock extends LamonByCoringModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("andesite_redstone_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:andesite_redstone_ore_match"),
			...
			event.getRegistry().register(feature.setRegistryName("andesite_redstone_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lamon_by_coring:andesite_redstone_ore"),
					configuredFeature);
		}
	}
	@SubscribeEvent
