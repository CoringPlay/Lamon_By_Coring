...
public class BlackSandBlock extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:black_sand")
	public static final Block block = null;

	public BlackSandBlock(LamonByCoringModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:black_sand_match"),
