...
public class MagentaSandBlock extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:magenta_sand")
	public static final Block block = null;
	public MagentaSandBlock(LamonByCoringModElements instance) {
		super(instance, 11);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:magenta_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("magenta_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lamon_by_coring:magenta_sand"), configuredFeature);
		}
	}
	@SubscribeEvent
