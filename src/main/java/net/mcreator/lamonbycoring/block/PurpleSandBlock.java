...
public class PurpleSandBlock extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:purple_sand")
	public static final Block block = null;

	public PurpleSandBlock(LamonByCoringModElements instance) {
		super(instance, 16);
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.SAND).sound(SoundType.SAND).hardnessAndResistance(0.25f, 7f).setLightLevel(s -> 0).harvestLevel(1)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:purple_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("purple_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lamon_by_coring:purple_sand"), configuredFeature);
		}
	}
