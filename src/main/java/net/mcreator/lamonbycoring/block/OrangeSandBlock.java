...
public class OrangeSandBlock extends LamonByCoringModElements.ModElement {
	@ObjectHolder("lamon_by_coring:orange_sand")
	public static final Block block = null;
	public OrangeSandBlock(LamonByCoringModElements instance) {
		super(instance, 10);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lamon_by_coring:orange_sand_match"),
			...
			event.getRegistry().register(feature.setRegistryName("orange_sand"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lamon_by_coring:orange_sand"), configuredFeature);
		}
	}
	@SubscribeEvent
